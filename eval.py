...
def main(args):
    ...
    for object_name in object_name_list:
        ...
        if not args.eval_only:
            ...
            for idx, que_id in enumerate(tqdm(que_ids,mininterval=2)):
                ...
                inter_img = visualize_intermediate_results(object_pts , object_diameter,img, K, inter_results, estimator.ref_info, object_bbox_3d, object_center, pose_gt,est_name,object_name,que_id)
        ...
        with open('../data/exp/performance.log','a') as f: f.write(msg_pr)
